...
var firebaseConfig = {
  apiKey: "AIzaSyBuT3eu28Nb5h6lhuNes0IUFTnC3X1ieLo",
  authDomain: "impro-869b7.firebaseapp.com",
  databaseURL: "https://impro-869b7.firebaseio.com",
  projectId: "impro-869b7",
  storageBucket: "impro-869b7.appspot.com",
  messagingSenderId: "534916808074",
  appId: "1:534916808074:web:62e49e151f7bc129965c73",
  measurementId: "G-TWDCK2S9QZ",
};
...
export default class App extends React.Component {
  ...
  async _stopRecordingAndEnablePlayback() {
    ...
    /*
    var downloadURI = await this.uploadImageAsync(info.uri);
    console.log(downloadURI);

    const sound = new Audio.Sound();
    try {
      await sound.loadAsync({ uri: downloadURI });
